...
// https://gist.githubusercontent.com/kuiwunb/30a71348035bf27bd9c1e36f6d2b980b/raw/xushanzhenxunjiangovo.js
...
const main = (config)  =>{
  ...
  config["proxy-groups"] = [
    ...
    },
    {
      ...
      "name": "Proxy",
      "type": "select",
      "proxies": ["HongKong", "TaiWan", "Japan", "Korea", "France", "Russia", "Thailand", "Singapore", "America", "AllServer", "Germany", "Vietnam", "DIRECT"],
    ...
    },
    {
      ...
      "name": "AI",
      "type": "select",
      "proxies": ["Proxy", "HongKong", "TaiWan", "Japan", "Korea", "France", "Russia", "Thailand", "Singapore", "America", "Germany", "Vietnam", "Republic of Moldova", "AllServer"],
    ...
    },
    {
      ...
      "name": "Emby",
      "type": "select",
      "proxies": ["Proxy", "HongKong", "TaiWan", "Japan", "Korea", "France", "Russia", "Thailand", "Singapore", "America", "Germany", "Vietnam", "Republic of Moldova", "AllServer", "DIRECT"],
    ...
    },
    {
      ...
      "type": "select",
      "proxies": ["MDA-Auto", "MDA-FallBack", "MDA-LoadBalance"],
      "include-all": true,
      "filter": "(?i)🇲🇩|索罗卡|德涅斯特|(\b(MDA|Republic of Moldova)\b)",
      "icon": "https://img0.baidu.com/it/u=2479587757,158053696&fm=253&fmt=auto&app=138&f=GIF?w=413&h=208"
    },
    {
      ...groupBaseOption,
      "name": "MDA-Auto",
