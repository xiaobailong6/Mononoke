...
// https://raw.githubusercontent.com/xiaobailong6/Mononoke/refs/heads/master/Clash/Config/Flclash-fz.js
...
const main = (config)  =>{
  ...
  config["proxy-groups"] = [
    ...
    },
    {
      ...
      "include-all": true,
      "filter": "(?i)uk|英国|伦敦|英格兰|(\b(UK|United Kingdom)\b)",
    ...
    },
    {
      ...
      "name": "Korea",
      "type": "select",
      "proxies": ["Kor-Auto", "Kor-FallBack", "Kor-LoadBalance"],
      "include-all": true,
      "filter": "(?i)kor|韩国|首尔|汉城|(\b(KOR|Korea)\b)",
    ...
    },
    {
      ...
      "include-all": true,
      "filter": "(?i)DE|德国|柏林|汉堡|(\b(DE|Germany)\b)",
    ...
    },
    {
      ...
      "hidden": true,
      "filter": "(?i)ru|俄罗斯|莫斯科|圣彼得堡|(\b(Ru|Russia)\b)",
      "icon": "https://gh-proxy.com/https://raw.githubusercontent.com/Koolson/Qure/master/IconSet/IconSet/Russia.png"
    },
    {
      ...groupBaseOption,
      "name": "Ru-FallBack",
    ...
    //策略组
    {
      ...
      "name": "AI",
      "type": "select",
      "proxies": ["Proxy", "HongKong", "TaiWan", "Japan", "Singapore", "America", "United Kingdom", "Korea","Germany", "France", "Russia", "AllServer"],
    ...
    },
    {
      ...
      "name": "Emby",
      "type": "select",
      "proxies": ["Proxy", "HongKong", "TaiWan", "Japan", "Singapore", "America", "United Kingdom", "Korea","Germany", "France", "Russia", "AllServer", "DIRECT"],
  ...
  config["rules"] = [
    ...
    "RULE-SET,twitter-domain,Twitter_X",
